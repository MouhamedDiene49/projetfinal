      ...
      <div className={`basket-alert ${basketMsgStatus ? "show" : ""}`}>
        <div className='alert-content'>
          <div className='alert-msg grid px-4'>
            ...
            <p className='fs-13'>Un nouvel article a été ajouté à votre panier. Vous avez maintenant 1 articles dans votre panier.</p>
          </div>
          <div className='basket-alert-btns px-4 py-4'>
            ...
            <Link to = "/basket" className='alert-btn fs-13 text-white bg-primary'>Voir Panier d'achat</Link>
            <Link to = "/home" className='alert-btn fs-13 text-primary'>Continuer vos achats</Link>
          </div>
        </div>
      </div>
